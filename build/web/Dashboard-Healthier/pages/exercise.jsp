  ...
  <main class="main-content position-relative border-radius-lg">
    ...
    <div class="container-fluid py-4">
      ...
      <div class="exercise-content row">
        <div class="body-section col-xl-6 col-lg-6" style="display: grid; place-items: center;">
          <!-- <div class="body-heading">
                  <p style="font-size: 2rem;font-weight: 500;" class="text-gradient">
                      Click muscle group
                  </p>
                  <i class="fa-solid fa-arrow-down fa-bounce"
                      style="font-size: 2.5rem; padding-bottom: 1.2rem;"></i>
              </div> -->
          <div class="body-map container" id="body-map">
            <div id="male-body-maps " class="body-map__container">
              <div class="text-center" style="margin: 0 auto;">
                <div class="body-map__body"><svg height="AUTO" width="50%" viewBox="0 0 673 1200" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <g class="body-map__muscle" id="abdominals" style="">
                      <path
        ...
        <div class="col-xl-6 col-lg-6" style="">
          <!-- Test card
              <div class="card" style="margin-top:2em ;">
                  <div class="workout-section" style="width: 80%; height: auto; margin: auto; margin-top: 2em;">
                      <div class="workout-name" style="text-align: center;">
                          <div class="name">Incline Hammer Curls</div>

                          <div class="introduce-workout" style="">
                              <div class="left-block">
                                  <div class="type" style="margin-bottom: 4rem; width: 100%;">
                                      <h4>type</h4>
                                      <p class="type">Strength</p>
                                  </div>
                                  <div class="equipment">
                                      <h4>Equipment</h4>
                                      <p class="equipment">Dumbbell</p>
                                  </div>
                              </div>
                              <div class="center-block">
                                  <div class="center-block-img">
                                      <img src="./asset/—Pngtree—sport and fitness icons gym_9122369.png" alt="">
                                  </div>
                              </div>
                              <div class="right-block">
                                  <div class="muscle" style="margin-bottom: 4rem; width: 100%;">
                                      <h4>muscle</h4>
                                      <p class="muscle">Biceps</p>
                                  </div>
                                  <div class="difificulty">
                                      <h4>difificulty</h4>
                      ...
                      <div class="workout-intrus">
                          <h3 class="intrustion">Instruction</h3>
                          <p class="sub-intrus instruction">
                             Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam nisi perferendis ipsam vel magni, molestiae illo recusandae fugiat dicta, voluptas quis animi adipisci deserunt, iste autem non impedit nihil cupiditate?</p>
                      </div>
                  </div>
                </div> -->
          ...
          <div class="card">
            ...
            <div class="workout-section" style="width: 80%; height: auto; margin: auto; margin-top: 2em;">
              <div class="workout-name" style="text-align: center;">
                ...
                <div class="introduce-workout" style="width: 100%">
                  <div class="left-block">
                    <div class="type" style="margin-bottom: 4rem; width: 100%;">
                      <h4>type</h4>
                      <p class="typeP" style="display:none;">ABC</p>
                    </div>
                    <div class="equipment">
                      <h4>Equipment</h4>
                      <p class="equipmentP"><img src="../asset/-person.png" style="width:25%" alt=""
                          style="display: none !important;">ABC</p>
                    </div>
                  </div>
                  <div class="center-block">
                    <div class="center-block-img">
                  ...
                  <div class="right-block">
                    <div class="muscle" style="margin-bottom: 4rem; width: 100%;">
                      <h4><img src="../asset/.png" alt="" style="width: 25%;"> muscle</h4>
                      <p class="muscleP" style="display:none;">ABC</p>
                    </div>
                    <div class="difificulty">
                      <h4>difificulty</h4>
                      <p class="levelP" style="display:none;">ABC</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="workout-intrus">
                <h3 class="intrustion"><img src="../asset/certificate.png" style="width:8%; height:auto;" alt="">
                  Instruction</h3>
                <p class="sub-intrus instructionP">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam nisi perferendis
                  ipsam vel magni, molestiae illo recusandae fugiat dicta, voluptas quis animi
                  adipisci deserunt, iste autem non impedit nihil cupiditate?</p>
                <br>
                <!-- Scrollable modal -->
                <div class="row">
                  ...
                  <div class="col-lg-6 col-sm-6 col-md-6">
                    <button style="margin-left:0" type="button" class="btn-primary gen">
                      Generate
                    </button>
                  </div>
                </div>
    ...
    <div class="modal fade" style="z-index: 999999;" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
      aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="staticBackdropLabel">Instruction</h1>
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6 mb-lg-0 mb-4">
            <div class="copyright text-center text-sm text-muted text-lg-start">
              ...
              <a href="#" class="font-weight-bold" target="_blank">Healthier</a>
              for a better web.
            </div>
          </div>
        </div>
...
<!--  <script>
  ...
  <div id="toast">
    <div id="img"></div>
    <div id="desc" style="height: 100%; ">
      <p style="  display: flex;
      justify-content: center;
      align-items: center;padding-top: 10px;"> Wait a minutes...</p>
    </div>
  </div>
