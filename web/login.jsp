                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                      <form id="reg_form">
                        <div class="d-flex align-items-center mb-3 pb-1">
                          ...
                          <span class="h1 fw-bold mb-5"><img src="./asset/pexels-pixabay-255469.jp" alt=""></span>
                        </div>
                        <h5 class="fw-normal mb-2 pb-" style="letter-spacing: 1px;">Sign into your account</h5>
                        <p class="mb-3 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="register.jsp"
